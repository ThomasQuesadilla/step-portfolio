...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeIsNotConsidered() {
    // Have person C have an all day event. We should see two options because 
  ...
  public void optionalAttendeeIsConsidered() {
    // Have person C have a 30 minute event. We should see two options because 
    // each person has split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
  ...
  public void optionalNotEnoughRoom() {
    // Person B is optional, should be ignored due to smaller time slot available than needed for meeting
    // have the meeting.
    //
    // Events  : |--A--|  |B||----A----|
    // Day     : |---------------------|
